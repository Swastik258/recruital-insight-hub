        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-left px-4 lg:px-8">
            <div className="flex items-center justify-center lg:justify-start space-x-2 mb-6">
              ...
              <h1 className="text-3xl font-bold text-gray-900">week-hr</h1>
            </div>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
              Start your free trial today
            </h2>
            <p className="text-gray-600 mb-6 text-lg leading-relaxed max-w-lg mx-auto lg:mx-0">
            ...
            <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-md">
              ...
              <CardContent className="space-y-4 px-6">
                <div className="grid grid-cols-2 gap-3">
                  <Button 
                    ...
                    className="w-full h-10 text-sm font-medium border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 hover:shadow-md"
                  >
              ...
              <form onSubmit={handleSignup}>
                ...
                <CardFooter className="flex flex-col space-y-4 px-6 pb-6">
                  <Button 
                    type="submit" 
                    className="w-full h-10 bg-blue-600 hover:bg-blue-700 text-white font-medium transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5" 
                    disabled={isLoading}
                  >
                    {isLoading ? (
